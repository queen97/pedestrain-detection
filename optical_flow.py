...
help_message = \
    '''
pedestrian detection using optical flow
'''
count = 0
...
if __name__ == '__main__':
    ...
    cap= cv2.VideoCapture('C:/Users/Raushni kumari/Downloads/intern report on pedestrian detection/intern report/video files/TownCentre.mp4')
    (ret, prev) = cap.read()
    ...
    while True:
        ...
        if show_hsv:
            ...
            for c in cnts:
                ...
                #if w > 50 and h > 50 and w < 80 and h < 70:
